...
urlpatterns = [
    ...
    path("arquivar-boa-pratica/<int:pk>/", views.arquivar_boa_pratica, name="arquivar_boa_pratica"),
    path("excluir-boa-pratica/<int:pk>/", views.arquivar_boa_pratica, name="excluir_boa_pratica"),
    ...
    path("arquivar-ferramenta/<int:pk>/", views.arquivar_ferramenta, name="arquivar_ferramenta"),
